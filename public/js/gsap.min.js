...
gsap.utils.toArray(".categories li").forEach((category) => {
let { label } = category.dataset;
    ...
    category.addEventListener("mouseleave", () => {
        gsap.to(`img[data-image=${label}]`, { opacity: 0, zIndex: 1, scale: 0.8 });
        gsap.set(`p[data-label=${label}]`, { zIndex: 1 });
    });
});
